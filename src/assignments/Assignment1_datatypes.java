...
//		2. Whether a customer has placed an order: true or false
		...
		System.out.println("2. Whether a customer has placed an order: true or false: "+orderPlacement);
...
//		4. Amount of money in a customer's bank account: 1000.50
		...
		System.out.println("4. Amount of money in a customer's bank account: "+bankBalance);
...
//		6. Coordinates of a location (latitude, longitude): 37.7749, -122.4194
		...
		System.out.println("6. Coordinates of a location ("+latitude+", "+longitude+")");
		
		
//		7. Person's marital status: true or false
		
		boolean maritalSt = false;
		
		System.out.println("7. Person's marital status: "+maritalSt);
		
		
//		8. Person's occupation: "Software Engineer"
		
		String occ = "Software Engineer";
		System.out.println("8. Person's occupation: "+occ);
...
//		15.Number of employees in a company: 500
		...
		System.out.println("15.Number of employees in a company: "+employeeCount);
...
//		17.Name of a country: "United States"
		...
		System.out.println("17.Name of a country: "+countryName);
